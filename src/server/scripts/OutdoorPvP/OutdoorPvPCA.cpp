...
{
	AddCreature(CREATURE_OTHER, 200006, 0, 37, 66.929f, 906.698f, 343.026f, 2.244f, 1000000);
	AddCreature(CREATURE_OTHER, 200006, 0, 37, 1215.098f, 249.887f, 355.152f, 5.710f, 1000000);
}
...
{
	for (CreatureSet::iterator itr = m_creature.begin(); itr != m_creature.end(); itr++)
		if(((*itr)->GetEntry() == 200107) || ((*itr)->GetEntry() == 200117))
...
public:
    ...
    struct npc_summon_npcAI : CasterAI
    {
       ...
       void UpdateAI(uint32 diff)
       {
			...
			{
				m_uiTimer = 60000;
				if(me->GetEntry() == 200118)
				{
						me->SummonCreature(200117, me->GetPositionX()+2.0f, me->GetPositionY()+7.0f, me->GetPositionZ(), 0.0f, TEMPSUMMON_CORPSE_DESPAWN, 1000);
						me->SummonCreature(200117, me->GetPositionX()+6.0f, me->GetPositionY()+12.0f, me->GetPositionZ(), 0.0f, TEMPSUMMON_CORPSE_DESPAWN, 1000);
						me->SummonCreature(200117, me->GetPositionX()-2.0f, me->GetPositionY()+2.0f, me->GetPositionZ(), 0.0f, TEMPSUMMON_CORPSE_DESPAWN, 1000);
						me->SummonCreature(200117, me->GetPositionX()-6.0f, me->GetPositionY()-3.0f, me->GetPositionZ(), 0.0f, TEMPSUMMON_CORPSE_DESPAWN, 1000);				
				}
				if(me->GetEntry() == 200108)
				{
						me->SummonCreature(200107, me->GetPositionX()+2.0f, me->GetPositionY()+7.0f, me->GetPositionZ(), 0.0f, TEMPSUMMON_CORPSE_DESPAWN, 1000);
						me->SummonCreature(200107, me->GetPositionX()+6.0f, me->GetPositionY()+12.0f, me->GetPositionZ(), 0.0f, TEMPSUMMON_CORPSE_DESPAWN, 1000);
						me->SummonCreature(200107, me->GetPositionX()-2.0f, me->GetPositionY()+2.0f, me->GetPositionZ(), 0.0f, TEMPSUMMON_CORPSE_DESPAWN, 1000);
						me->SummonCreature(200107, me->GetPositionX()-6.0f, me->GetPositionY()-3.0f, me->GetPositionZ(), 0.0f, TEMPSUMMON_CORPSE_DESPAWN, 1000);	
				}
			}
			else
				m_uiTimer -= diff;
...
#define GOSSIP_ITEM_1  "Go to Battlefield: Azshara Crater"
...
public:
	...
	bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action)
    {
		...
		case GOSSIP_ACTION_INFO_DEF+1:
			...
			{
				creature->MonsterTextEmote("For Sending you have to be 254th level!", player->GetGUID(), true);
			...
			{
				creature->MonsterTextEmote("For Sending you need 300 Honor!", player->GetGUID(), true);
			    player->CLOSE_GOSSIP_MENU();
			    return false;
			}
...
#define GOSSIP_ITEM_2  "Finish the fight and go to the capital"
