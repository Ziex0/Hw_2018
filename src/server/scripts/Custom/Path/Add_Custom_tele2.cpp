...
public:
	...
	void MainMenu(Player *pPlayer, Creature *pCreature)
	{
		...
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_DOT, "|TInterface/icons/achievement_zone_ashenvale_01:35:35|t|cff0000ff Buffs Me UP", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2500);
		...
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_DOT, "|TInterface/ICONS/Achievement_Zone_Azshara_01:35:35|t|cffff0000 Chill Area", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1110);
