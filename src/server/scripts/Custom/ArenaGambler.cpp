...
{ public:
    ...
    bool OnGossipHello(Player* pPlayer, GameObject* pGo)
    {
        ...
        else
        {
            switch (urand(0,5))
            {
            case 0: pPlayer->MonsterSay("I never fought once , i should be ashamed.",0,pPlayer->GetGUID()); break;
            case 1: pPlayer->MonsterSay("This book does not hold any records of me!",0,pPlayer->GetGUID()); break;
            case 2: pPlayer->MonsterSay("i have never challenged anyone here!",0,pPlayer->GetGUID());break;
            case 3: pPlayer->MonsterSay("I should first challenge someone!",0,pPlayer->GetGUID()); break;
            case 4: pPlayer->MonsterSay("No Wins, No losses",0,pPlayer->GetGUID()); break;
            case 5: pPlayer->MonsterSay("I should hide in a cave, i don't deserve to be here!",0,pPlayer->GetGUID()); break;
            }
        }
        return true;
    }
