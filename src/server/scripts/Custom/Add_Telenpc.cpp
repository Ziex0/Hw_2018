...
public:
	...
	void MainMenu(Player *pPlayer, Creature *pCreature)
	{
		...
		//pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "--|cffFF00DEChill Area--", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1110);
    ...
    bool OnGossipSelect(Player* pPlayer, Creature* pCreature, uint32 /*uiSender*/, uint32 uiAction)
    {
		...
		switch (uiAction)
		{
			...
			case GOSSIP_ACTION_INFO_DEF + 8910:
				...
				pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Azshara Crater", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 33001);
				...
				//pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Armor Lv 5", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 33005);
				//pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Armor Lv 6", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 33006);
				//pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Armor Lv 7", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 33007);
				//pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Armor Lv 8", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 33008);
				//pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Armor Lv 9", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 33009);
				//pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Armor Lv 10", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 33010);
				...
				pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Weapon Lv 1", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 43001);
				pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Weapon Lv 2", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 43002);
				pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Weapon Lv 3", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 43003);
				pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Weapon Lv 4", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 43004);
				pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Weapon Lv 5", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 43005);
				pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Weapon Lv 6", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 43006);
				pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Weapon Lv 7", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 43007);
				pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Weapon Lv 8", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 43008);
				pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Weapon Lv 9", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 43009);
				pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Weapon Lv 10", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 43010);
				...
				pPlayer->CLOSE_GOSSIP_MENU();
				pPlayer->TeleportTo(37, 223.73f, 79.4347f, 236.864f, 3.70537f);
				break;
				//LV2
				...
				pPlayer->CLOSE_GOSSIP_MENU();
				pPlayer->TeleportTo(0, -8245.26f, -223.755f, 299.47f, 1.54675f);
				break;
