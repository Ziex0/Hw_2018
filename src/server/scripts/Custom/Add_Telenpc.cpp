...
public:
	...
	void MainMenu(Player *pPlayer, Creature *pCreature)
	{
		...
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "|TInterface/ICONS/INV_Misc_Gear_01:24|t Gold and Transmorg mall", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 9000);
