...
(100000, 0, 0, 'So the Light''s vaunted justice has finally arrived? Shall I lay down Frostmourne and throw myself at your mercy, Fordring?', 14, 0, 0, 0, 0, 17349, 'The Lich King - SAY_LK_INTRO_1'),
(100000, 1, 0, 'You''ll learn of that first hand. When my work is complete, you will beg for mercy -- and I will deny you. Your anguished cries will be testament to my unbridled power...', 14, 0, 0, 22, 0, 17350, 'The Lich King - SAY_LK_INTRO_2'),
(100000, 2, 0, 'I''ll keep you alive to witness the end, Fordring. I would not want the Light''s greatest champion to miss seeing this wretched world remade in my image.', 14, 0, 0, 0, 0, 17351, 'The Lich King - SAY_LK_INTRO_3'),
(100000, 3, 0, 'Come then champions, feed me your rage!', 14, 0, 0, 0, 0, 0, 'The Lich King - SAY_LK_AGGRO'),
(100000, 4, 0, 'I will freeze you from within until all that remains is an icy husk!', 14, 0, 0, 0, 0, 17369, 'The Lich King - SAY_LK_REMORSELESS_WINTER'),
(100000, 5, 0, 'Watch as the world around you collapses!', 14, 0, 0, 0, 0, 17370, 'The Lich King - SAY_LK_QUAKE'),
(100000, 6, 0, 'Val''kyr, your master calls!', 14, 0, 0, 0, 0, 17373, 'The Lich King - SAY_LK_SUMMON_VALKYR'),
(100000, 7, 0, 'Frostmourne hungers...', 14, 0, 0, 0, 0, 17366, 'The Lich King - SAY_LK_HARVEST_SOUL'),
(100000, 8, 0, 'Argh... Frostmourne, obey me!', 14, 0, 0, 0, 0, 17367, 'The Lich King - SAY_LK_FROSTMOURNE_ESCAPE'),
(100000, 9, 0, 'Frostmourne feeds on the soul of your fallen ally!', 14, 0, 0, 0, 0, 17368, 'The Lich King - SAY_LK_FROSTMOURNE_KILL'),
(100000, 10, 0, 'Hope wanes!', 14, 0, 0, 0, 0, 17363, 'The Lich King - SAY_LK_KILL'),
(100000, 10, 1, 'The end has come!', 14, 0, 0, 0, 0, 17364, 'The Lich King - SAY_LK_KILL'),
(100000, 11, 0, 'Face now your tragic end!', 14, 0, 0, 0, 0, 17365, 'The Lich King - SAY_LK_BERSERK'),
(100000, 12, 0, '%s begins to cast Defile!', 41, 0, 0, 0, 0, 0, 'The Lich King - EMOTE_DEFILE_WARNING'),
(100000, 13, 0, '|TInterface\\Icons\\ability_creature_disease_02.blp:16|tYou have been infected by |cFFCF00FFNecrotic Plague!|r', 42, 0, 0, 0, 0, 0, 'The Lich King - EMOTE_NECROTIC_PLAGUE_WARNING'),
(100000, 14, 0, 'No questions remain unanswered. No doubts linger. You ARE Azeroth''s greatest champions. You overcame every challenge I laid before you. My mightiest servants have fallen before your relentless onslaught... your unbridled fury...', 14, 0, 0, 0, 0, 17353, 'The Lich King - SAY_LK_OUTRO_1'),
(100000, 15, 0, 'Is it truly the righteousness that drives you? I wonder...', 14, 0, 0, 0, 0, 17354, 'The Lich King - SAY_LK_OUTRO_2'),
(100000, 16, 0, 'You trained them well, Fordring. You delivered the greatest fighting force this world has ever known... right into my hands -- exactly as I intended. You shall be rewarded for your unwitting sacrifice.', 14, 0, 0, 0, 0, 17355, 'The Lich King - SAY_LK_OUTRO_3'),
(100000, 17, 0, 'Watch now as I raise them from the dead to become masters of the Scourge. They will shroud this world in chaos and destruction. Azeroth''s fall will come at their hands -- and you will be the first to die.', 14, 0, 0, 0, 0, 17356, 'The Lich King - SAY_LK_OUTRO_4'),
(100000, 18, 0, 'I delight in the irony...', 14, 0, 0, 0, 0, 17357, 'The Lich King - SAY_LK_OUTRO_5'),
(100000, 19, 0, 'Impossible...', 14, 0, 0, 0, 0, 17358, 'The Lich King - SAY_LK_OUTRO_6'),
(100000, 20, 0, 'Now I stand, the lion before the lambs... and they do not fear.', 14, 0, 0, 0, 0, 17361, 'The Lich King - SAY_LK_OUTRO_7'),
(100000, 21, 0, 'They cannot fear.', 14, 0, 0, 0, 0, 17362, 'The Lich King - SAY_LK_OUTRO_8');
*/
...
#define MIN_PAUSE_CHATTER		16000	
...
#define MODEL_THE_FALLEN  	30721 
#define MODEL_CLONE_DIED	24641

class The_Fallen : public CreatureScript
{
public:
    The_Fallen() : CreatureScript("The_Fallen"){}

    CreatureAI* GetAI(Creature* pCreature) const
    {
        return new The_FallenAI(pCreature);
    }

    struct The_FallenAI : public ScriptedAI
    {
        The_FallenAI(Creature *c) : ScriptedAI(c) {}

        EventMap events;

        uint32 addztimer;
        uint32 _last_lk_special;
        ...
        void KilledUnit(Unit* victim)
        {
            ...
            {
                me->MonsterSay("Hah you cant defeat me !!! Come back again later !!",LANG_UNIVERSAL,NULL);
                if (RAND(1,2) == 1) Talk(RAND(SAY_LK_FROSTMOURNE_KILL, SAY_LK_HARVEST_SOUL, SAY_LK_KILL)); // 
                _chatter_timer = 0;
            }
        }
