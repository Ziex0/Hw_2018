...
public:
    ...
    struct boss_bartimusAI : public ScriptedAI
    {
        ...
        void DamageTaken(Unit* /*pAttacker*/, uint32 &damage)
        {
            ...
            {
                me->MonsterTextEmote(EMOTE_INSANE, 0, true);
                me->InterruptNonMeleeSpells(false);
                me->MonsterYell("ARGHH... MY HEAD", LANG_UNIVERSAL, NULL);
        ...
        void EnterCombat(Unit* /*who*/)
        {
            ...
            me->MonsterYell("Invisibility is the Best!!", LANG_UNIVERSAL, NULL);
        }
        ...
        {
            me->MonsterYell("I'am go now...", LANG_UNIVERSAL, NULL);
            Summons.DespawnAll();
            ResetPlayersPhaseMask();
