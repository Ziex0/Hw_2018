	...
	return false;
		...
		break;
            ...
            case 303:
                ...
                break;
            case 304:
                RewardItem(player, pCreature,100130,1,7);
                break;
			case 310:
                player->PlayerTalkClass->ClearMenus();
	     ...
	     case 305: // invincible off set
		  ...
		  break;
            ...
            case 2001:
                ...
                break;
            case 2101:
                RewardItem(player, pCreature,200169,1,9);
                break;
			case 2102:
                RewardItem(player, pCreature,200170,1,9);
                break;
			case 2103:
                RewardItem(player, pCreature,200171,1,9);
                break;
			case 2104:
                RewardItem(player, pCreature,200180,1,9);
                break;
			case 2105:
                RewardItem(player, pCreature,200228,1,9);
                break;
            ...
            case 2002:
                ...
                break;
            case 2201:
                RewardItem(player, pCreature,200176,1,15);
                break;
            case 2202:
                RewardItem(player, pCreature,200178,1,15);
                break;
            case 2203:
                RewardItem(player, pCreature,200177,1,15);
				break;
			case 2204:
                RewardItem(player, pCreature,200230,1,15);
				break;
            ...
            case 2301:
                ...
                RewardItem(player, pCreature,200179,1,15);
                player->PlayerTalkClass->SendCloseGossip();
						}
                break;
            ...
            case 2302:
                ...
                RewardItem(player, pCreature,200229,1,15);
                player->PlayerTalkClass->SendCloseGossip();
						}
            ...
            case 2004:
                ...
                break;
            case 2401:
                RewardItem(player, pCreature,34334,1,9);
                break;
            case 2402:
                RewardItem(player, pCreature,200173,1,9);
                break;
            case 2403:
                if(player->getClass() == CLASS_PALADIN || player->getClass() == CLASS_ROGUE || player->getClass() == CLASS_WARRIOR || player->getClass() == CLASS_DEATH_KNIGHT || player->getClass() == CLASS_HUNTER) {
				char str[200];
                ...
                RewardItem(player, pCreature,200181,1,7);
                player->PlayerTalkClass->SendCloseGossip();
		  }
                break;
            //case 2005:
                ...
                break;
            case 2501:
                RewardItem(player, pCreature, 200167,1,7);
                break;
            case 2502:
                RewardItem(player, pCreature, 200168,1,7);
                break;
            ...
            case 3003:
                RewardItem(player, pCreature, 200162,1,6);
                break;
            case 3004:
                RewardItem(player, pCreature, 200216,1,6);
                break;
            case 3005:
                RewardItem(player, pCreature, 200163,1,6);
                break;
			case 3006:
                RewardItem(player, pCreature, 200217,1,6);
                break;
			case 3007:
                RewardItem(player, pCreature, 200161,1,6);
                break;
			case 3008:
                RewardItem(player, pCreature, 200215,1,6);
                break;
            case 3009:
			...
			case 14010:
				...
				break;
            case 4001:
                RewardItem(player, pCreature, 361800,1,1);
                break;
            case 4002:
