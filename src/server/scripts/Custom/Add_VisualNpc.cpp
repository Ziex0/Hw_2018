...
public:
    ...
    void SetVisual(Player* player, uint32 visual)
    {
        ...
        if (!item)
        {
            ChatHandler(player->GetSession()).PSendSysMessage("No Item available to change the Visual.");
            return;
        }
    ...
    {
        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TRAINER, "|TInterface/ICONS/INV_Misc_Gear_01:24|t Main-Hand", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TRAINER, "|TInterface/ICONS/INV_Misc_Gear_01:24|t Off-Hand", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TRAINER, "|TInterface/ICONS/INV_Misc_Coin_03:24|t Back", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
