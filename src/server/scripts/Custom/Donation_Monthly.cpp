...
static uint32 permaMonthsVipPrice = 60;
...
public:
	...
	bool OnGossipHello(Player * pPlayer, Creature * pCreature)
	{
		...
		if (SelectDPoints(pPlayer) < permaMonthsVipPrice)
			...
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "|TInterface/icons/Spell_Shadow_Shadowform:25|tPurchase |cffFF0000Premium|r permanent (|cff009900Unlocked|r / Click to use) 60 Dp", GOSSIP_SENDER_MAIN, 5);
	...
	bool OnGossipSelect(Player * pPlayer, Creature * pCreature, uint32 sender, uint32 uiAction)
	{
		...
		case 1: // Vip accounts - LOCKED
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_DOT, "This |cffFF0000Premium|r rank same like |cffFF0000Premium|r permanent.. Custom Commands.. Free |cffFF0000Premium|r set..diffrent his |cffFF0000Premium|r use timer.. There you can choose how long you want be Premium rank on Server, or you can Get Permanent :)", GOSSIP_SENDER_MAIN, 1000);
