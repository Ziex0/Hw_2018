...
class premium_rate : public CreatureScript
{
    public:
        ...
        {
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_DOT, "|TInterface/ICONS/INV_Misc_Book_11:30:30:-18:0|t Set me to premium Rank 1", GOSSIP_SENDER_MAIN, 2000);
			//pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_DOT, "|TInterface/ICONS/INV_Misc_Book_11:30:30:-18:0|t Set me to premium Rank 2", GOSSIP_SENDER_MAIN, 6000);
