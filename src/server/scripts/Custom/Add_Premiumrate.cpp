...
class premium_rate : public CreatureScript
{
    public:
        ...
        {
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_DOT, "|TInterface/ICONS/INV_Misc_Book_11:30:30:-18:0|t Set me to Premium member", GOSSIP_SENDER_MAIN, 2000);
				...
				if(pPlayer->HasItemCount(320265, 1))
		{
			...
			char str[200];
			sprintf(str,"Your now premium member, thank you for supporting our server! please close your Wow and Re-login");
