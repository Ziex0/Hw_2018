...
public:
    ...
    ChatCommand* GetCommands() const
    {
        static ChatCommand guildCommandTable[] =
        {
			...
			{ "linfo",    		SEC_GAMEMASTER,    	true, &HandleGuildLInfoCommand,             "", NULL },
            { "setlevel", 		SEC_GAMEMASTER,		true, &HandleGuildSetLevelCommand,          "", NULL },
            { "givexp",   		SEC_GAMEMASTER,  	true, &HandleGuildGiveXpCommand,            "", NULL },
