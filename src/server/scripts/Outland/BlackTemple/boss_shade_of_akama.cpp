...
public:
    ...
    struct boss_shade_of_akamaAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            ...
            if (instance)
                instance->SetData(DATA_SHADE_OF_AKAMA, NOT_STARTED);
...
public:
    ...
    struct npc_akamaAI : public ScriptedAI
    {
        npc_akamaAI(Creature* creature) : ScriptedAI(creature), summons(me)
        {
            ...
            instance = creature->GetInstanceScript();
            if (instance)
                ShadeGUID = instance->GetData64(DATA_AKAMA_SHADE);
            else
        ...
        void BeginEvent(Player* player)
        {
            ...
            if (Shade)
            {
                instance->SetData(DATA_SHADE_OF_AKAMA, IN_PROGRESS);
        ...
        void UpdateAI(uint32 diff)
        {
            ...
            {
                if (instance)
                    instance->SetData(DATA_SHADE_OF_AKAMA, DONE);
