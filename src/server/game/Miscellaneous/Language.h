...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
	...
	// Show Kick in world
    LANG_COMMAND_KICKMESSAGE_WORLD 			= 14000,
    // Show Mute in world
    LANG_COMMAND_MUTEMESSAGE_WORLD 			= 14001,

    // Show Ban in world
    LANG_BAN_CHARACTER_YOUBANNEDMESSAGE_WORLD     = 14002,
    LANG_BAN_CHARACTER_YOUPERMBANNEDMESSAGE_WORLD = 14003,
    LANG_BAN_ACCOUNT_YOUBANNEDMESSAGE_WORLD       = 14004,
    LANG_BAN_ACCOUNT_YOUPERMBANNEDMESSAGE_WORLD   = 14005,
    ...
    LANG_OPVP_CA_LOOSE_TOWER_A_A        	= 16000,
    LANG_OPVP_CA_LOOSE_TOWER_B_A        	= 16001,
    LANG_OPVP_CA_LOOSE_TOWER_C_A        	= 16002,
    LANG_OPVP_CA_LOOSE_TOWER_D_H        	= 16003,
    LANG_OPVP_CA_LOOSE_TOWER_E_H        	= 16004,
