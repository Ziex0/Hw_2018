...
public:
    ...
    struct warrior_botAI : public bot_minion_ai
    {
        ...
        void UpdateAI(uint32 diff)
        {
            ...
            if (Rand() < 30 && batcomShout_cd <= diff && GC_Timer <= diff && getrage() > 100 &&
        ...
        void Attack(uint32 diff)
        {
            ...
            //EXECUTE
            if (EXECUTE && tank != me && Rand() < 70 && GC_Timer <= diff && getrage() > 150 &&
            ...
            //WHIRLWIND
            if (WHIRLWIND && Rand() < 50 && whirlwind_cd <= diff && GC_Timer <= diff && getrage() >= 250 && tank != me &&
