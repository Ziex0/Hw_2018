...
public:
    ...
    struct shaman_botAI : public bot_minion_ai
    {
        ...
        void OnBotDespawn(Creature* summon)
        {
            ...
            {
                sLog->outError(LOG_FILTER_GENERAL, "SummonedCreatureDespawn(): Shaman bot %s has despawned summon %s which is not a temp summon or not a totem...", me->GetName().c_str(), summon->GetName().c_str());
                return;
            }
            ...
            switch (totem->m_Properties->Id)
            {
                ...
                case SUMMON_TYPE_TOTEM_AIR:
                    ...
                    break;
                default:
                    sLog->outError(LOG_FILTER_GENERAL, "SummonedCreatureDespawn(): Shaman bot %s has despawned totem %s with unknown type %u", me->GetName().c_str(), summon->GetName().c_str(), totem->m_Properties->Id);
                    return;
            }
        ...
        void OnBotSummon(Creature* summon)
        {
            ...
            if (!totem || !totem->ToTotem())
            {
                sLog->outError(LOG_FILTER_GENERAL, "OnBotSummon(): Shaman bot %s has summoned creature %s which is not a temp summon or not a totem...", me->GetName().c_str(), summon->GetName().c_str());
                return;
            }
            ...
            switch (totem->m_Properties->Id)
            {
                ...
                case SUMMON_TYPE_TOTEM_AIR:
                    ...
                    break;
                default:
                     sLog->outError(LOG_FILTER_GENERAL, "OnBotSummon(): Shaman bot %s has summoned totem %s with unknown type %u", me->GetName().c_str(), summon->GetName().c_str(), totem->m_Properties->Id);
                    return;
            }
