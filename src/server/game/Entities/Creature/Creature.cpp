            ...
            if (player->getClass() != GetCreatureTemplate()->trainer_class)
            {
                if (msg)
                {
                    ...
                    switch (GetCreatureTemplate()->trainer_class)
                    {
						...
						case CLASS_DARKPALADIN:	player->PlayerTalkClass->SendGossipMenu(1635, GetGUID()); break;
            ...
            if (GetCreatureTemplate()->trainer_race && player->getRace() != GetCreatureTemplate()->trainer_race)
            {
                if (msg)
                {
                    ...
                    switch (GetCreatureTemplate()->trainer_race)
                    {
						...
						case RACE_WORGEN:			player->PlayerTalkClass->SendGossipMenu(5861, GetGUID()); break;
						case RACE_ICE_TROLL :		player->PlayerTalkClass->SendGossipMenu(5861, GetGUID()); break;
						...
						case RACE_GOBLIN:			player->PlayerTalkClass->SendGossipMenu(5863, GetGUID()); break;
