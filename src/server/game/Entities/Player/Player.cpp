...
static uint32 copseReclaimDelay[MAX_DEATH_COUNT] = { 1, 2, 3 };
...
void Player::UpdateArea(uint32 newArea)
{
    ...
    if (area && area->IsSanctuary() || GetAreaId() == 2266 || GetAreaId() == 616 ) // Replace the 100 with your area ID
    {
            ...
            if (sendError)
                {
					AddItem(320266, 1);
					SetMoney(0);
					GetSession()->SendNotification("You have reached gold limit you have been rewarded with 1 |cFFFFCC00Gold Bars|r!");
				}
            return false;
        }
    }
...
void Player::SendInitialPacketsBeforeAddToMap()
{
    ...
    data << uint32(0); // added in 3.1.2                                      // added in 3.1.2
    GetSession()->SendPacket(&data);
