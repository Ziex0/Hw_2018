...
bool WorldSession::DosProtection::EvaluateOpcode(WorldPacket& p, time_t time) const
{
	...
	sLog->outError(LOG_FILTER_GENERAL,"network", "AntiDOS: Account %u, IP: %s, Ping: %u, Character: %s, flooding packet (opc: %s (0x%X), count: %u)",
	...
	case POLICY_BAN:
	{
		...
		//sWorld->BanAccount(bm, nameOrIp, duration.str(), "DOS (Packet Flooding/Spoofing", "Server: AutoDOS");
